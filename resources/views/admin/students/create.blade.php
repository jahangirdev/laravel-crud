                        ...
                        <div class="card-body">
                            <form action="{{route('students.store')}}" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" id="student-name" value="{{old('name')}}">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="roll" type="number" class="form-control @error('roll') is-invalid @enderror" id="roll" value="{{old('roll')}}">
                                    @error('roll')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
